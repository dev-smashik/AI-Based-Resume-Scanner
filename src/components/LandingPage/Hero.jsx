    ...
    <section id="home" className="flex flex-col md:flex-row justify-between items-center px-4 sm:px-6 lg:px-8 pt-44 pb-16 container mx-auto">
      ...
      <div className="w-full md:w-1/2 space-y-8">
        ...
        >
          ...
          <button className=" bg-blue-600 text-white px-6 py-4.5 rounded-lg hover:bg-blue-700 text-sm font-medium transition-all hover:shadow-lg hover:shadow-blue-100">
            Upload your Resume →
          </button>
        </motion.div>
      </div>
